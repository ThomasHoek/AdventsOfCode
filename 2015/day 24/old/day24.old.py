...
# recursive solve where we try to solve a, b and c to 0.
def recursive_solution(
    ...
    if a.collected_str in key_dict:
        return  # type: ignore
...
def puzzle(puzzle_input: list[int]) -> Any:
    ...
    combos: list[list[int]] = [[int(x2) for x2 in x.split("_")[1:]]
                               for x in list(key_dict.keys())]
